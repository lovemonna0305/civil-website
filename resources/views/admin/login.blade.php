...
<head>
    ...
    <title>Login - Nessim Engineering</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('backend/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('backend/img/favicon.png') }}" rel="apple-touch-icon">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        <div class="d-flex justify-content-center py-4">
                            <a href="#" class="logo d-flex align-items-center w-auto">
                                <img src="backend/img/laravel.png" alt="">
                                <!-- <span class="d-none d-lg-block">LaraConstruction</span> -->
                            </a>
                        </div><!-- End Logo -->
                                ...
                                @csrf
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" value="{{old('email')}}" name="email" class="form-control" id="yourEmail" required>
                        ...
                        <div class="credits">
                            Designed by <a href="#">Nessim Engineering Ltd</a>
                        </div>
